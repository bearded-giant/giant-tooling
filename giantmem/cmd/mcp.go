	...
	s.AddTool(
		mcp.NewTool("find_artifact",
			append([]mcp.ToolOption{
				...
				mcp.WithString("since",
					mcp.Description(`only artifacts updated on/after this — duration ("7d", "4h"), date ("2026-06-01"), or RFC3339`)),
				mcp.WithString("until",
					mcp.Description(`only artifacts updated on/before this — duration ("1d"), date ("2026-06-30"), or RFC3339`)),
