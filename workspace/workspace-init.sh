...
1. Search for key patterns: entry points, config files, main modules
2. Append discoveries to .giantmem/context/discoveries.md in format:
...
1. If git repo, add recent commits summary to .giantmem/context/git-log.md:
...
echo ""
echo "Or use aliases: ws, wsd, wsc"
echo ""
